        ...
        subject
                ...
                .flatMap(go -> {
                    ...
                    if (stageSchedulingInfo != null && (stageSchedulingInfo.getScalingPolicy() != null ||
                        ...
                        if (clutchConfiguration.isPresent()) {
                            try {

                                ClutchConfiguration config = getClutchConfiguration(clutchConfiguration.get())
                                        .get(stage);
