...
public final class ChildFirstClassLoader extends URLClassLoader {
  ...
  /**
   * The classes that should always go through the parent ClassLoader. This is relevant for Mantis
   * classes, for example, to avoid loading Mantis classes that cross the user-code/system-code
  ...
  public ChildFirstClassLoader(
      Collection<URL> urls,
      ClassLoader parent,
      Collection<String> alwaysParentFirstPatterns) {
