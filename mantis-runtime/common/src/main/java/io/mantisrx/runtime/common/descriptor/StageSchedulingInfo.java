...
import io.mantisrx.runtime.common.JobConstraints;
...
public class StageSchedulingInfo {
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("StageSchedulingInfo{");
        sb.append("numberOfInstances=").append(numberOfInstances);
        sb.append(", machineDefinition=").append(machineDefinition);
        sb.append(", hardConstraints=").append(hardConstraints);
        sb.append(", softConstraints=").append(softConstraints);
        sb.append(", scalingPolicy=").append(scalingPolicy);
        sb.append(", scalable=").append(scalable);
        sb.append('}');
        return sb.toString();
    }
