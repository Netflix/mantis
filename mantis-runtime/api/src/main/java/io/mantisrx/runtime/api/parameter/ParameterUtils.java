...
import io.mantisrx.runtime.api.parameter.type.BooleanParameter;
import io.mantisrx.runtime.api.parameter.type.IntParameter;
import io.mantisrx.runtime.api.parameter.type.StringParameter;
import io.mantisrx.runtime.api.parameter.validator.Validation;
import io.mantisrx.runtime.api.parameter.validator.Validators;
import io.mantisrx.runtime.common.MantisSSEConstants;
...
public class ParameterUtils {
    ...
    static final ConcurrentHashMap<String, ParameterDefinition<?>> SYSTEM_PARAMS
    ...
    static {
        ParameterDefinition<Integer> keyBuffer = new IntParameter()
                ...
                .build();
        SYSTEM_PARAMS.put(keyBuffer.getName(), keyBuffer);
        ...
        SYSTEM_PARAMS.put(useSPSC4sse.getName(), useSPSC4sse);
        ...
        SYSTEM_PARAMS.put(useSPSC4w2w.getName(), useSPSC4w2w);
        ...
        SYSTEM_PARAMS.put(singleNettyThread.getName(), singleNettyThread);
        ...
        ParameterDefinition<Integer> w2wtoKeyMaxChunkSize = new IntParameter()
                ...
                .build();
        SYSTEM_PARAMS.put(w2wtoKeyMaxChunkSize.getName(), w2wtoKeyMaxChunkSize);
        ...
        ParameterDefinition<Integer> w2wtoKeyThreads = new IntParameter()
                ...
                .defaultValue(1)
                .build();
        SYSTEM_PARAMS.put(w2wtoKeyThreads.getName(), w2wtoKeyThreads);
        ...
        ParameterDefinition<Integer> sseBuffer = new IntParameter()
                ...
                .defaultValue(25000)
                .build();
        SYSTEM_PARAMS.put(sseBuffer.getName(), sseBuffer);
        ...
        ParameterDefinition<Integer> sseChunkSize = new IntParameter()
                ...
                .defaultValue(1000)
                .build();
        SYSTEM_PARAMS.put(sseChunkSize.getName(), sseChunkSize);
        ...
        ParameterDefinition<Integer> sseMaxReadTime = new IntParameter()
                ...
                .defaultValue(250)
                .build();
        SYSTEM_PARAMS.put(sseMaxReadTime.getName(), sseMaxReadTime);

        //mantis.sse.numConsumerThreads 1

        ParameterDefinition<Integer> sseNumConsumerThreads = new IntParameter()
                .name("mantis.sse.numConsumerThreads")
                .validator(Validators.range(1, 8))
                .description("number of consumer threads draining the queue to write to SSE")
                .defaultValue(1)
                .build();
        SYSTEM_PARAMS.put(sseNumConsumerThreads.getName(), sseNumConsumerThreads);
        ...
        ParameterDefinition<String> jobMasterAutoScaleMetric = new StringParameter()
                ...
                .defaultValue("")
                .build();
        SYSTEM_PARAMS.put(jobMasterAutoScaleMetric.getName(), jobMasterAutoScaleMetric);
        ...
        ParameterDefinition<String> jobMasterAutoScaleConfig = new StringParameter()
                ...
                .defaultValue("")
                .build();
        SYSTEM_PARAMS.put(jobMasterAutoScaleConfig.getName(), jobMasterAutoScaleConfig);
        ...
        ParameterDefinition<Boolean> clutchExperimentalEnabled = new BooleanParameter()
                ...
                .defaultValue(false)
                .build();
        SYSTEM_PARAMS.put(clutchExperimentalEnabled.getName(), clutchExperimentalEnabled);
        ...
        ParameterDefinition<String> jvmOptions = new StringParameter()
                ...
                .build();
        SYSTEM_PARAMS.put(jvmOptions.getName(), jvmOptions);
        ...
        ParameterDefinition<Integer> stageConcurrency = new IntParameter()
                ...
                .build();
        SYSTEM_PARAMS.put(stageConcurrency.getName(), stageConcurrency);
        ...
        for (int stageNum = 0; stageNum <= MAX_NUM_STAGES_FOR_JVM_OPTS_OVERRIDE; stageNum++) {
            ...
            SYSTEM_PARAMS.put(paramName, new StringParameter()
                    .name(paramName)
                    .validator(Validators.alwaysPass())
                    .defaultValue("")
        ...
        ParameterDefinition<Boolean> sseBinary = new BooleanParameter()
                ...
                .build();
        SYSTEM_PARAMS.put(sseBinary.getName(), sseBinary);
        ...
        ParameterDefinition<String> compressionDelimiter = new StringParameter()
                ...
                .build();
        SYSTEM_PARAMS.put(compressionDelimiter.getName(), compressionDelimiter);
    }
    ...
    public static Parameters createContextParameters(
        ...
        parameterDefinitions.putAll(SYSTEM_PARAMS);
    ...
    private static void validationCheck(Function validator, Object value,
        ...
        try {
            validatorOutcome = (Validation) validator.apply(value);
        } catch (Throwable t) {
        ...
        for (Parameter parameter : parameters.values()) {
            ...
            if (definition == null) {
                ...
                if (name.startsWith("mantis.") || name.startsWith("MANTIS")) {
                    ...
                    definition = SYSTEM_PARAMS.get(name);
                } else {
                    logger.warn("No parameter definition for parameter with name: {}, will skip parameter", name);
                    continue;
                }
            }
            Function validator = definition.getValidator().getValidator();
    ...
    public static Map<String, ParameterDefinition<?>> getSystemParameters() {
        return Collections.unmodifiableMap(SYSTEM_PARAMS);
    }
}
