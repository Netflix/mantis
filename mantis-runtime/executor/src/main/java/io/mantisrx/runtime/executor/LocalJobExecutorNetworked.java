...
import io.mantisrx.runtime.common.command.CommandException;
...
public class LocalJobExecutorNetworked {
    ...
    private static final Runnable nullAction = () -> System.exit(0);
...
//                                    Context context, Publisher<Integer> stageWorkersObservable) {
...
//        }
//
//        Publisher<Set<Endpoint>> endpoints = staticEndpoints(previousStagePorts, stageNumber, workerIndex,
//            numPartitions);
...
//    private static Publisher<Set<Endpoint>> staticEndpoints(final int[] ports, final int stageNum,
...
//    }
//
//    private static EndpointInjector staticInjector(final Publisher<Set<Endpoint>> endpointsToAdd) {
//        return new EndpointInjector() {
//            @Override
//            public Publisher<EndpointChange> deltas() {
//                return endpointsToAdd.flatMap(new Func1<Set<Endpoint>, Publisher<EndpointChange>>() {
//                    @Override
//                    public Publisher<EndpointChange> call(Set<Endpoint> t1) {
//                        return
//                                Observable.from(t1)
