...
public interface LifecycleEventPublisher {
    ...
    static LifecycleEventPublisher noop() {
        return new LifecycleEventPublisher() {
            @Override
            ...
            @Override
            public void publishWorkerListChangedEvent(
                WorkerListChangedEvent workerListChangedEvent) {
