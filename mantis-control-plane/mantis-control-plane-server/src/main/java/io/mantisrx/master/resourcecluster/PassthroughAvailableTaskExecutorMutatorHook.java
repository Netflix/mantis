...
public class PassthroughAvailableTaskExecutorMutatorHook implements AvailableTaskExecutorMutatorHook {
    @Override
    public Stream<TaskExecutorHolder> mutate(Stream<TaskExecutorHolder> taskExecutorHolderStream, TaskExecutorBatchAssignmentRequest request, SchedulingConstraints schedulingConstraints) {
        return taskExecutorHolderStream;
    }
}
