...
public class ScalerSettings {
     ...
     */
    Duration rulesetRefreshInterval;

    public static ScalerSettings fromConfig(Config config) {
        return
            ScalerSettings.builder()
                .pullInterval(config.getDuration("pullInterval"))
                .rulesetRefreshInterval(config.getDuration("rulesetRefreshInterval"))
                .build();
    }
}
