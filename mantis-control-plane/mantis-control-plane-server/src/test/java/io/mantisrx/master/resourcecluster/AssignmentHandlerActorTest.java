...
public class AssignmentHandlerActorTest {
    ...
    public static class ForwarderParent extends AbstractActor {
        ...
        public ForwarderParent(Props childProps, ActorRef probe, TaskExecutorGateway taskExecutorGateway) {
            this.childProps = childProps;
            this.probe = probe;
        ...
        public Receive createReceive() {
            return receiveBuilder()
                .match(TaskExecutorGatewayRequest.class, request -> {
                    // Return a fresh gateway future for retries
