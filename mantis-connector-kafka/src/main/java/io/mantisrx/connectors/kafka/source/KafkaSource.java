...
import io.mantisrx.connectors.kafka.KafkaData;
import io.mantisrx.connectors.kafka.KafkaDataNotification;
...
import io.mantisrx.connectors.kafka.source.checkpoint.trigger.CheckpointTrigger;
import io.mantisrx.connectors.kafka.KafkaSourceParameters;
import io.mantisrx.connectors.kafka.KafkaAckable;
import io.mantisrx.connectors.kafka.source.metrics.ConsumerMetrics;
import io.mantisrx.connectors.kafka.source.serde.ParseException;
import io.mantisrx.connectors.kafka.source.serde.Parser;
...
import static io.mantisrx.connectors.kafka.source.MantisKafkaSourceConfig.CONSUMER_RECORD_OVERHEAD_BYTES;
import static io.mantisrx.connectors.kafka.source.MantisKafkaSourceConfig.DEFAULT_ENABLE_STATIC_PARTITION_ASSIGN;
import static io.mantisrx.connectors.kafka.source.MantisKafkaSourceConfig.DEFAULT_MAX_BYTES_IN_PROCESSING;
import static io.mantisrx.connectors.kafka.source.MantisKafkaSourceConfig.DEFAULT_NUM_KAFKA_CONSUMER_PER_WORKER;
import static io.mantisrx.connectors.kafka.source.MantisKafkaSourceConfig.DEFAULT_PARSE_MSG_IN_SOURCE;
