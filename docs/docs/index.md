...
To learn more about Mantis, visit the [Getting Started guide](gettingstarted/local) or check out the [Concepts overview](gettingstarted/concepts.md) or
browse through the list of [use cases](gettingstarted/usecases.md) powered by Mantis.
To get involved with community, visit the [Community page](community) where you can subscribe to one of our mailing lists.
For a detailed Programming Guide on writing Mantis Jobs, refer to the [Writing Mantis Jobs](developing/writingjobs) chapters.
